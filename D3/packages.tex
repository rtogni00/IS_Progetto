...
\setlength{\aboverulesep}{0pt}  % Rimuove lo spazio sopra le righe colorate
\setlength{\belowrulesep}{0pt}  % Rimuove lo spazio sotto le righe colorate
...
%		\vspace{1cm}
	...
	\begin{table}[!htb]
		\begin{tabular}{lllll}
			\cline{1-4}
			\cellcolor[HTML]{13315C}{\color[HTML]{FFFFFF} Doc. Name}                         & D3-EvenTrentoImplementazione & \multicolumn{1}{l|}{\cellcolor[HTML]{13315C}{\color[HTML]{FFFFFF} Doc. Number}} & \multicolumn{1}{l|}{D3 V1.3} &  \\ \cline{1-4}
