...
const UserModel = require('./models/user') // get our mongoose model
...
router.post('', async function(req, res) {
	...
	if ( req.body.googleToken ) {
		...
		user = await UserModel.findOne({ email: payload['email'] }).exec();
		if ( ! user ) {
			user = new UserModel({
				email: payload['email'],
			...
			console.log('UserModel created after login with google');
