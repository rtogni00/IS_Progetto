...
%		\vspace{1cm}
	...
	\begin{table}[!htb]
		\centering
		\resizebox{\textwidth}{!}{
			\begin{tabular}{|p{4cm}|p{4.5cm}|p{4cm}|p{4.5cm}|}
				\hline
				\cellcolor[HTML]{13315C}{\color[HTML]{FFFFFF} Doc. Name} 
				& D4-EvenTrentoReportFinale 
				& \cellcolor[HTML]{13315C}{\color[HTML]{FFFFFF} Doc. Number} 
				& D4 V0.3 \\ \hline
				\multicolumn{1}{|l|}{\cellcolor[HTML]{13315C}{\color[HTML]{FFFFFF} Description}} 
				& \multicolumn{3}{|p{9cm}|}{Report Finale del progetto: organizzazione del lavoro, tempo complessivo dedicato al progetto, criticità, autovalutazione} \\ \hline
			\end{tabular}
		}
	\end{table}
